...
ARoguePlayerCharacter::ARoguePlayerCharacter()
{
	...
	RougeActionSystemComponent = CreateDefaultSubobject<URougeActionSystemComponent>(TEXT("RougeActionSystemComp"));
...
void ARoguePlayerCharacter::PostInitializeComponents()
{
	...
	RougeActionSystemComponent->OnHealthChanged.AddDynamic(this, &ARoguePlayerCharacter::OnHealthChanged);
}
...
void ARoguePlayerCharacter::AttackTimerElapsed(TSubclassOf<ARogueProjectile> ProjectileClass)
{
	...
	FRotator EyeRotation = CameraComponent->GetComponentRotation();
	...
	{
		FRotator AdjustedSpawnRotation = (Hit.Location - SpawnLocation).Rotation();
		
		SpawnRotation = AdjustedSpawnRotation;
	}
	else 
	{
		FRotator AdjustedSpawnLocation = (TraceEnd - SpawnLocation).Rotation();	
		
		SpawnRotation = AdjustedSpawnLocation;
                                        ...
                                        class AController* EventInstigator, AActor* DamageCauser)
{
	...
	RougeActionSystemComponent->ApplyHealthChange(-ActualDamage);
